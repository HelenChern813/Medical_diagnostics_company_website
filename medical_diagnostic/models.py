...
class Doctors(models.Model):
    ...
    qualification = models.TextField(
        verbose_name="Курсы квалификации", blank=True, null=True, help_text="Введите названия курсов квалификации"
    )
    schedule = models.CharField(
        max_length=255, verbose_name="Расписание", help_text="Пример: Пн-Пт 9:00-18:00, Сб 10:00-15:00", blank=True
    )
