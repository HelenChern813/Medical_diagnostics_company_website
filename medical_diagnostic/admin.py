...
from .models import Feedback, Services, Content, Doctors, Contacts, Appointment, DiagnosticResults
...
class ContentAdmin(admin.ModelAdmin):
    ...
    list_filter = ("name_content", "text_content",)
    search_fields = ("name_content", "text_content",)
...
class AppointmentAdmin(admin.ModelAdmin):
    ...
    list_filter = ("user", "appointment_date",)
    search_fields = ("user", "appointment_date",)
...
class DiagnosticResultsAdmin(admin.ModelAdmin):
    ...
    list_filter = ("user", "service", "doctor", "date_performed",)
    search_fields = ("user", "service", "doctor", "date_performed",)
